...
const string strMessageMagic = "trumpinsane Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "trumpinsane", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "trumpinsane";
        CTransaction txNew;
        if (!fTestNet)
        {
            txNew.nTime = 1467638924; 
        }
        else
        {
            txNew.nTime    = 1467637776; // Without separate txNew.nTime near block.nTime, CheckBlock fails on coinbase timestamp for TestNet created on 14042015
        }
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        // debug print
        assert(block.hashMerkleRoot == uint256("0xe3c8e92b0ebd965bce67f5c7d741caaf6635a8b7425e6179469e7a32a2c87aa6"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xa6, 0xd3, 0xb2, 0xf1 };
